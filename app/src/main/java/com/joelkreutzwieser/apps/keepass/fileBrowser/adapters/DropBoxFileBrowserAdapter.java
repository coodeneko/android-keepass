...
public class DropBoxFileBrowserAdapter  extends RecyclerView.Adapter<DropBoxFileBrowserAdapter.ViewHolder> {
    ...
    public DropBoxFileBrowserAdapter(List<DropboxAPI.Entry> myDataset) {
        mDataset = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public DropBoxFileBrowserAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                            int viewType) {
        // create a new view
